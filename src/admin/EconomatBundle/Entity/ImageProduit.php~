 ...
 * @ORM\Table(name="imageproduit")
 * @ORM\Entity(repositoryClass="admin\EconomatBundle\Entity\ImageProduitRepository")
 */
class ImageProduit {
    ...
    /**
     * @var Produit  $produit
     * @ORM\ManyToOne(targetEntity="admin\EconomatBundle\Entity\Produit", inversedBy="imagepros")

 ...
 * @ORM\Entity(repositoryClass="admin\EconomatBundle\Entity\CategorieProduitRepository")
 */
class CategorieProduit
{
     ...
     * @ORM\OneToMany(targetEntity="admin\EconomatBundle\Entity\Produit", cascade={"persist", "remove"}, mappedBy="categorie")
     */
    private $produits;

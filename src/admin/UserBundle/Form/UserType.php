...
//    public function __construct($maxLength, $idProfil = 0) {
...
//    }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder
                ...
                ->add('tel1', TextType::class, array('required' => TRUE, 'attr' => array('required' => TRUE, 'placeholder' => "Téléphone *", 'class' => 'form-control numeric')))
                ->add('tel2', TextType::class, array('required' => FALSE, 'attr' => array('required' => FALSE, 'placeholder' => "Téléphone", 'class' => 'form-control numeric')))
            ...
            $builder->add('profil', EntityType::class, array(
                ...
                'query_builder' => function (\Doctrine\ORM\EntityRepository $repository) {
                    $qb = $repository->createQueryBuilder('m')
                            ...
                            ->setParameters(array(0 => TypeEtat::ACTIF, 'tp' => TypeProfil::PROFIL_UTILISATEUR));
                    return $qb;
                },
                        
                'required' => TRUE,
                'attr' => array('required' => TRUE,'readonly' => TRUE, 'class' => 'form-control')));
                ...
                $builder->add('password', PasswordType::Class, array('required' => TRUE, 'attr' => array('required' => TRUE, 'placeholder' => 'Mot de passe *', 'class' => 'form-control')))
